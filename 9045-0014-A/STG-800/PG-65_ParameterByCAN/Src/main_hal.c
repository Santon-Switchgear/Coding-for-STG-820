...
{
	uint16_t u16PId = ((CAN_PG65_t*)(hcan->pRxMsg->Data))->u16PId;
	uint8_t u8Send = 1;
	uint8_t u8PNo = ((CAN_PG65_t*)(hcan->pRxMsg->Data))->u8PNo;
	
	if ( u8PNo >= PG65_PARAMETER_COUNT )
		return;
	
	hcan->pTxMsg->IDE = CAN_ID_STD;
	hcan->pTxMsg->StdId = 0x7FE;
	hcan->pTxMsg->DLC = 7;
	((CAN_PG65_t*)(hcan->pTxMsg->Data))->u8PNo = u8PNo;
	((CAN_PG65_t*)(hcan->pTxMsg->Data))->u16PId = u16PId + 2000;

	switch ( u16PId )
	{
		case 1100: // Parameter count
			hcan->pTxMsg->DLC = 4;
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.u8 = PG65_PARAMETER_COUNT;
			u8Send = 1;
			break;
		case 1102: // Minimal value
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.i32 = PG65[u8PNo].i32LowerLimit;
			break;
		case 1103: // Maximal value
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.i32 = PG65[u8PNo].i32UpperLimit;
			break;
		case 1104: // Default value
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.i32 = PG65[u8PNo].i32Default;
			break;
		case 1105: // Step size
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.i32 = PG65[u8PNo].i32StepSize;
			break;
		case 1106: // Decimal point
			hcan->pTxMsg->DLC = 4;
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.u8 = PG65[u8PNo].u8Decimals;
			break;
		case 1107: // Unit
			hcan->pTxMsg->DLC = 4;
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.u8 = PG65[u8PNo].u8Unit;
			break;
		case 1108: // Description Part 1
			hcan->pTxMsg->DLC = 8;
			memcpy(((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.ch, PG65[u8PNo].cDescription, 5);
			break;
		case 1109: // Description Part 2
			hcan->pTxMsg->DLC = 8;
			memcpy(((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.ch, &PG65[u8PNo].cDescription[5], 5);
			break;
		case 1110: // Function
			hcan->pTxMsg->DLC = 4;
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.u8 = PG65[u8PNo].u8Function;
			break;
		case 1120: // Value
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.i32 = PG65[u8PNo].i32Value;
			break;
		case 2120: // Change Value
			PG65[u8PNo].i32Value = ((CAN_PG65_t*)(hcan->pRxMsg->Data))->v.i32;
			((CAN_PG65_t*)(hcan->pTxMsg->Data))->v.i32 = PG65[u8PNo].i32Value;
		  ((CAN_PG65_t*)(hcan->pTxMsg->Data))->u16PId = u16PId + 1000;
		default:
			u8Send = 0;
	}
