...
#ifndef __math_h
#define __math_h
#define __ARMCLIB_VERSION 6160001
...
#define _ARMABI __attribute__((__nothrow__)) _ARM_OVERRIDE_PCS
#else
#define _ARMABI __attribute__((__nothrow__))
#endif
#if (defined(__ARM_64BIT_STATE) || defined(__TARGET_ARCH_AARCH64))
# define _ARMABI_SOFTFP __attribute__((__nothrow__))
#else
# define _ARMABI_SOFTFP __attribute__((__nothrow__)) __attribute__((__pcs__("aapcs")))
#endif
#if !defined(__TARGET_ARCH_AARCH64)
# define __HAVE_LONGDOUBLE 1
#endif
#if defined(_ARM_OVERRIDE_PCS)
#define _ARMABI_PURE __attribute__((__nothrow__)) __attribute__((__const__)) _ARM_OVERRIDE_PCS
#else
...
#else
# define _ARMABI_FPEXCEPT _ARMABI __attribute__((__const__))
#endif
