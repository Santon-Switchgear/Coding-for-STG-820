...
volatile uint16_t u16SwTimer[SW_TIMER_CNT];
...
{
	// Decrement u16SwTimer every 1 ms down to 0
	uint8_t u8I;
...
/**
  * @brief  Set Voltage at Analog output 
  * @param  u16mV Output Voltage [mV]
  * @retval None
  */
